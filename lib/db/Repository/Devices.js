    ...
    const deviceRepository = {
        ...
        getDevicesLastData: async function() {
            let query = "select users.company_name as CompanyName, devices.route_name as RouteName, " +
                ...
                "(select peripheral_gps_data.idDevice " +
                "from peripheral_gps_data where peripheral_gps_data.idDevice = devices.idDevice order by peripheral_gps_data.createdAt desc limit 1" +
